...
hi DiffAdd         guifg=#437019 guibg=#313c36 gui=bold       ctermfg=66  ctermbg=237 cterm=bold
hi DiffChange      guibg=#2B5B77                              ctermbg=236
hi DiffDelete      guifg=#700009 guibg=#464646                ctermfg=236 ctermbg=238
hi DiffText        guifg=#8fbfdc guibg=#41363c gui=bold       ctermfg=217 ctermbg=237 cterm=bold
