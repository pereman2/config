...
Plug 'vim-scripts/a.vim' " switch to c header
...
autocmd FileType c,cpp,cc set expandtab
autocmd FileType c,cpp,cc set tabstop=2
autocmd FileType c,cpp,cc set softtabstop=2
autocmd FileType c,cpp,cc set shiftwidth=2

:command Compilenotes !cd ~/Dropbox/notes/vimwiki && make
" Some basics:
nnoremap c "_c
set nocompatible
filetype plugin on
...
:command -nargs=0 SearchReferences :call SearchReferencesFun()
nmap <silent> gr :SearchReferences<CR>
...
map <leader>dt :VimwikiMakeDiaryNote

let g:vimwiki_folding = 'expr'

au BufNewFile ~/Dropbox/notes/vimwiki/diary/*.md :silent 0r !~/Dropbox/notes/scripts/vimdiary.py '%'
...
autocmd FileType c,cpp,cc nnoremap == :<C-u>ClangFormat<CR>
